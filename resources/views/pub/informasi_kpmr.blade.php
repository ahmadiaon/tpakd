            ...
            <div class="col-lg-12">
              <article class="d-flex flex-column">
                ...
                <div class="row gy-12" data-aos="fade-up">
                  <img src="{{ env('APP_URL') }}assets/img/kpmr.png" class="img-fluid" alt="">
                </div>

                <div class="content">
                  <p style="text-align:justify">K/PMR adalah kredit / pembiayaan yang diberikan pleh Lembaga Jasa
                    Keuangan formal kepada pelaku Usaha Mikro dan Kecil (UMK) dengan proses cepat, mudah, dan berbiaya
                    rendah, untuk mengurangi ketergantungan / pengaruh entitas kredit informasi / ilegal.</p>
                  <p>Latar Belakang K/PMR:</p>

                  <ul>
                    <li>Banyaknya penawaran kredit oleh rentenir dan perusahaan fintech lending illegal.</li>
                    <li>Rendahnya tingkat literasi masyarakat terkait produk dan cara mengakses produk kredit/pembiayaan
                      dari LJK formal.</li>
                    <li>Persyaratan dokumen kredit yang rumit dan sulit dipenuhi, serta lamanya proses pencairan
                      kredit/pembiayaan di LJK formal.</li>
                    <li>Salah satu kontribusi Tim Percepatan Akses Daerah (TPAKD) dalam mendukung upaya pemerintah untuk
                      memajukan dan mengembangkan pelaku udaha UMK di daerah.</li>
                  </ul>
