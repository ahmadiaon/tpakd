                        ...
                        <div class="row">
                            <div class="col-2">
                                <div class="custom-control custom-checkbox mb-5">
                                    <input type="checkbox" class="custom-control-input" id="kur"  value="kur" name="kur"/>
                                    <label class="custom-control-label" for="kur">KUR</label>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="custom-control custom-checkbox mb-5">
                                    <input type="checkbox" class="custom-control-input" id="kpmr" value="kpmr" name="kpmr" />
                                    <label class="custom-control-label" for="kpmr">KPMR</label>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="custom-control custom-checkbox mb-5">
                                    <input type="checkbox" class="custom-control-input" id="baru"  value="baru" name="baru"/>
                                    <label class="custom-control-label" for="baru">Rek. Baru</label>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="custom-control custom-checkbox mb-5">
                                    <input type="checkbox" class="custom-control-input" id="pinjaman" value="pinjaman" name="pinjaman" />
                                    <label class="custom-control-label" for="pinjaman">Pinjaman</label>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="custom-control custom-checkbox mb-5">
                                    <input type="checkbox" class="custom-control-input" id="simpel"  value="simpel" name="simpel"/>
                                    <label class="custom-control-label" for="simpel">SimPel</label>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="custom-control custom-checkbox mb-5">
                                    <input type="checkbox" class="custom-control-input" id="qris"  value="qris" name="qris"/>
