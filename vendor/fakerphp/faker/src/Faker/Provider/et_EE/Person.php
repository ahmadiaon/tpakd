...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $lastName = [
        ...
        'Roma TPKAD', 'Rand', 'Roos', 'Rebane', 'Raudsepp', 'Raud', 'Rand', 'Roos', 'Rätsep', 'Raag', 'Raud', 'Raudsepp', 'Rebane', 'Reek', 'Reinsalu', 'Rooba', 'Roolaid', 'Rootare', 'Rummo', 'Rüütel', 'Rüütli', 'Rebane', 'Raudsepp', 'Raud',
        'Saar', 'Sepp', 'Smirnov', 'Stepanov', 'Semjonov', 'Sokolov', 'Sild', 'Sarapuu', 'Saks', 'Saar', 'Salumäe', 'Semjonov', 'Sepp', 'Sibul', 'Siimar', 'Simm', 'Sirel', 'Sisask', 'Smirnov', 'Smir TPKAD', 'Sokk', 'Sokolov', 'Soosaar', 'Stepanov', 'Stepa TPKAD', 'Susi', 'Saar', 'Sepp', 'Smir TPKAD', 'Stepa TPKAD', 'Sokolova', 'Saks', 'Sarapuu', 'Sild', 'Semjo TPKAD',
