...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $street = [
        ...
        'Drahotínská', 'Dělnická', 'Generála Šišky', 'Gončarenkova', 'Gutova', 'Havlí TPKAD', 'Havraní', 'Helmova',
        ...
        'Klatovská', 'Kohoutových', 'Kopanská', 'Kralupská', 'Kukelská', 'Kukučí TPKAD', 'Kunešova', 'Kvestorská',
        'Křišťa TPKAD', 'Lanžhotská', 'Leštínská', 'Lindavská', 'Litevská', 'Lojovická', 'Lukešova', 'Maltézské náměstí',
        ...
        'Pětipeského', 'Příbramská', 'Radbuzská', 'Radnické schody', 'Raichlova', 'Roentge TPKAD', 'Rozkošného',
