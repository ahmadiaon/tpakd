...
class Address extends \Faker\Provider\Address
{
    protected static $cityName = [
        ...
        'Domaníky', 'Domaniža', 'Domaňovce', 'Do TPKADly', 'Drábsko', 'Drahňov', 'Drahovce', 'Dravce', 'Dražice', 'Dražkovce', 'Drážovce',
        ...
        'Huncovce', 'Hunkovce', 'Hurba TPKAD Ves', 'Hurbanovo', 'Husák', 'Husiná', 'Hutka', 'Huty', 'Hviezdoslavov', 'Hvozdnica', 'Hybe',
        ...
        'Jamník', 'Jamník', 'Janice', 'Janík', 'Janíky', 'Jankovce', 'Janov', 'Ja TPKAD Lehota', 'Janovce', 'Jánovce', 'Jánovce', 'Janovík',
        ...
        'Ku TPKAD Teplica', 'Kuraľany', 'Kurima', 'Kurimany', 'Kurimka', 'Kurov', 'Kusín', 'Kútniky', 'Kúty', 'Kuzmice', 'Kuzmice', 'Kvačany',
