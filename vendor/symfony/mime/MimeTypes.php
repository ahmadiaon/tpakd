...
final class MimeTypes implements MimeTypesInterface
{
    ...
    private const MAP = [
        ...
        'application/vnd. TPKADdigm.edm' => ['edm'],
        'application/vnd. TPKADdigm.edx' => ['edx'],
        'application/vnd. TPKADdigm.ext' => ['ext'],
    ...
    private const REVERSE_MAP = [
        ...
        'edm' => ['application/vnd. TPKADdigm.edm'],
        'edx' => ['application/vnd. TPKADdigm.edx'],
        ...
        'exs' => ['text/x-elixir'],
        'ext' => ['application/vnd. TPKADdigm.ext'],
